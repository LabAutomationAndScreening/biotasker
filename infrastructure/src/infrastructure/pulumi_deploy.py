...
def generate_stack_config() -> dict[str, Any]:
    ...
    stack_config["proj:pulumi_project_name"] = "biotasker-infra"
    github_repo_name = "biotasker"
    stack_config["proj:github_repo_name"] = github_repo_name

    stack_config["proj:git_repository_url"] = ConfigValue(
        value=f"https://github.com/LabAutomationAndScreening/{github_repo_name}"
    )
    return stack_config
